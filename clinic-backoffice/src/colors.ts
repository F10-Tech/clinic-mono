...
export const extendedColorsBgLight = {
  white: 'bg-white text-black',
  light: 'bg-white text-black dark:bg-slate-900/70 dark:text-white',
  contrast: 'bg-gray-800 text-white dark:bg-white dark:text-black',
  success: 'bg-emerald-500 border-emerald-500 text-white',
  ...
  successLight: 'bg-emerald-200 text-black',
  dangerLight: 'bg-red-200 text-black',
  warningLight: 'bg-yellow-200 text-black',
  infoLight: 'bg-blue-200 text-black',
  successDark: 'bg-emerald-700 text-white',
  dangerDark: 'bg-red-700 text-white',
  warningDark: 'bg-yellow-700 text-white',
  infoDark: 'bg-blue-700 text-white',
  lightest: 'bg-gray-100 text-black',
  darkest: 'bg-gray-900 text-white',
};
